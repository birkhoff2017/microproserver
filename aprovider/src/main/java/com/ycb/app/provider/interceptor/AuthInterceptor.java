package com.ycb.app.provider.interceptor;
...
public class AuthInterceptor extends WebMvcConfigurerAdapter {
    @Bean
    com.ycb.app.provider.interceptor.AuthHandlerInterceptor authHandlerInterceptor() {
        return new com.ycb.app.provider.interceptor.AuthHandlerInterceptor();
    }
