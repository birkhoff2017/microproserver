...
import com.ycb.app.provider.vo.Shop;
import com.ycb.app.provider.vo.ShopStation;
...
public interface ShopMapper {
    ...
    @Results({
            ...
            @Result(property = "shopStation", column = "station_id", many = @Many(select = "com.ycb.app.provider.mapper.ShopMapper.findStations"))
    })
