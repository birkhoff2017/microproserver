                ...
                $.each(obj, function(n,value){
                    ...
                    if("12568".indexOf(status) > -1) {
                        if (flag){
                            ...
                            var viewH="<div class='viewH'><p class='bottom_textview'>租借时长:<span class='last_time'>"+lasttime+"</span></p><div class='viewH-bottom'><div class='cost'><div class='bottom_textview'>产生费用:<span class='use_fee'>"+usefee+"</span></div><div class='contraction' onclick = 'one(this)'><div class='firstlookup showhide'><img class='up' src='img/jdtlook.png'></img><span class='look'>查看</span></div><div class='firstpackdown showhide'><img class='down' src='img/jdtpack.png'></img><span class='pack'>收起</span></div></div></div></div></div>"
                            _head += underway;
                            doneview += "<div class='doneview1'>" + _head + middle + viewH +"</div>";
                            flag = false;
                        }else {
                            ...
                            var viewH="<div class='viewH'><p class='bottom_textview'>租借时长:<span class='last_time'>"+lasttime+"</span></p><div class='viewH-bottom'><div class='cost'><div class='bottom_textview'>产生费用:<span class='use_fee'>"+usefee+"</span></div><div class='contraction' onclick = 'one(this)'><div class='lookup showhide'><img class='up' src='img/jdtlook.png'></img><span class='look'>查看</span></div><div class='packdown showhide'><img class='down' src='img/jdtpack.png'></img><span class='pack'>收起</span></div></div></div></div></div>"
                            _head += underway;
                            doneview += "<div class='doneview1'>" + _head + middle + viewH +"</div>";
                        }
                    } else {
                        if (flag){
                            var middle = "<div class='firstmiddle'><p class='weui_cell_bd_p'>租借地点:<span class='borrow_name'>"+borrowname+"</span></p><p class='weui_cell_bd_p'>租借时间:<span class='borrow_time'>"+borrowtime+"</span></p><p class='weui_cell_bd_p'>收费标准:<span class='fee_strategy'>"+feestrategy+"</span></p><p class='weui_cell_bd_p'>归还地点:<span class='return_name'>"+returnname+"</span></p><p class='weui_cell_bd_p'>归还时间:<span class='return_time'>"+returntime+"</span></p></div>"
                            var viewH="<div class='viewH'><p class='bottom_textview'>租借时长:<span class='last_time'>"+lasttime+"</span></p><div class='viewH-bottom'><div class='cost'><div class='bottom_textview'>产生费用:<span class='use_fee'>"+usefee+"</span></div><div class='contraction' onclick = 'one(this)'><div class='firstlookup showhide'><img class='up' src='img/look.png'></img><span class='look'>查看</span></div><div class='firstpackdown showhide'><img class='down' src='img/pack.png'></img><span class='pack'>收起</span></div></div></div></div></div>"
                            _head += complete;
