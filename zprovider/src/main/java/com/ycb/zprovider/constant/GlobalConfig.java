...
public class GlobalConfig {
    ...
    //主域名
    public static final String Z_GATEWAY_URL = "http://www.duxinyuan.top/";
    //图文消息大图片
    ...
    //支付宝授权回调地址 需要url转码
    public static final String Z_AOUTH_REDIRECT_URI = "http%3a%2f%2fwww.duxinyuan.top%2foauth%2foauthNotify";
    //支付宝生活号关注推广链接
