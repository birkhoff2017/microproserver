...
public interface StationMapper {
    ...
    @Select("SELECT t.cable, t.borrow_station_id AS id, s.mac, t.customer FROM ycb_mcs_tradelog t,ycb_mcs_station s WHERE t.borrow_station_id=s.sid AND t.orderid=#{outTradeNo}")
