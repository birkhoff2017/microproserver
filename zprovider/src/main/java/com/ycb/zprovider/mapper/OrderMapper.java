...
public interface OrderMapper {
    ...
    @Results(id = "station", value = {
            ...
            @Result(property = "feeStrategyEntity", column = "fee_settings", one = @One(select = "com.ycb.zprovider.mapper.FeeStrategyMapper.findFeeStrategy"))
    })
    ...
    @Select("SELECT borrow_station_id,status,cable,orderid,order_no,return_time,price,return_shop_id,borrow_time,usefee" +
